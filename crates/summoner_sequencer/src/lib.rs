...
pub mod ep_gesture;
pub mod generative;
pub mod glass_gesture;
pub mod grand_piano_gesture;
pub mod groove;
pub mod hurdy_gurdy_gesture;
pub mod koto_gesture;
pub mod mallet_gesture;
pub mod markov_mutator;
pub mod midi_tools;
pub mod pattern;
pub mod pattern_tools;
pub mod pipe_organ_gesture;
pub mod pluck_gesture;
pub mod rotary_gesture;
pub mod session_looper;
pub mod shakuhachi_gesture;
pub mod sitar_gesture;
...
pub use glass_gesture::*;
pub use grand_piano_gesture::*;
pub use groove::{apply_groove_quantize, GrooveTemplate};
pub use hurdy_gurdy_gesture::*;
pub use koto_gesture::*;
pub use mallet_gesture::*;
pub use markov_mutator::*;
pub use midi_tools::*;
pub use pattern_tools::*;
pub use pipe_organ_gesture::*;
pub use pluck_gesture::*;
pub use rotary_gesture::*;
pub use session_looper::*;
pub use shakuhachi_gesture::*;
pub use sitar_gesture::*;
...
mod tests {
    ...
    fn test_timeline_step_swing_and_pan_pitch() {
        ...
        assert!(
            (ev.beat_offset - 0.3125).abs() < 1e-5,
            "Swing delay should shift beat to ~0.3125"
        );
    }
