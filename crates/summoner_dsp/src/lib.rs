...
pub mod cassotto_chamber;
pub mod clavinet;
pub mod composites;
pub mod compressor;
pub mod console_emulation;
pub mod crystal_resonator;
pub mod delay;
pub mod distortion;
pub mod dither;
